    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Movement Settings [4]
                ...
                new ButtonInfo { buttonText = "Clone offset X", overlapText = "Clone offset X <color=grey>[</color><color=green>0</color><color=grey>]</color>", method =() => Movement.ChangeCloneOffset(0), enableMethod =() => Movement.ChangeCloneOffset(0), disableMethod =() => Movement.ChangeCloneOffset(0, false), incremental = true, isTogglable = false, toolTip = "Changes the offset X for the clone mods."},
                new ButtonInfo { buttonText = "Clone offset Y", overlapText = "Clone offset Y <color=grey>[</color><color=green>0</color><color=grey>]</color>", method =() => Movement.ChangeCloneOffset(1), enableMethod =() => Movement.ChangeCloneOffset(1), disableMethod =() => Movement.ChangeCloneOffset(1, false), incremental = true, isTogglable = false, toolTip = "Changes the offset Y for the clone mods."},
                new ButtonInfo { buttonText = "Clone offset Z", overlapText = "Clone offset Z <color=grey>[</color><color=green>0</color><color=grey>]</color>", method =() => Movement.ChangeCloneOffset(2), enableMethod =() => Movement.ChangeCloneOffset(2), disableMethod =() => Movement.ChangeCloneOffset(2, false), incremental = true, isTogglable = false, toolTip = "Changes the offset Z for the clone mods."}
            },
